<?php
	...
	$meta['image'] = false;
	$default_image = get_bloginfo('template_directory') . '/images/og-default.png';
	...
	} elseif ( get_field('design_images') ) {
		$images = get_field('design_images');
		$meta['image'] = $images[0]['design_image']['sizes']['portfolio-full'];
